...
import { ClassaugmentedData, ReturnClassAgumentation } from '../../reduxToolkit/Slices/classificationSlices';
    ...
    const saveHandler = async () => {
        ...
        if (!num_of_images_to_be_generated) {
            ...
            try {
                ...
                const response = await dispatch(ClassaugmentedData({ payload:formData, signal: abortControllerReff.current.signal, url }))
