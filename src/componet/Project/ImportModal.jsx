                            ...
                            {!onClose ? (
                                ...
                                <>
                                    ...
                                    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-5 relative">
                                        ...
                                        <p className="text-blue-100 text-sm mt-1">Import in progress</p>
                                    </div>
                                    ...
                                    <div className="p-8 text-center">
                                        ...
                                        <motion.div
                                            ...
                                            className="w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center"
                                        >
