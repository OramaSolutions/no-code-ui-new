            ...
            {isComplete ? (
                <>
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        onClick={onProceed}
                        className=" px-6 py-3 w-full flex justify-center items-center bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl  gap-2"
                    >
