                ...
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
                        <motion.div
                            ...
                            className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl pointer-events-auto overflow-hidden max-h-[95vh] flex flex-col"
                        >
                            {/* Header */}
                            ...
                            {!loading && imageData && (
                                <motion.div
                                    ...
                                    className="px-8 pb-8 pt-4 border-t-2 border-slate-200 flex justify-center gap-4"
                                >
                                    <motion.button
