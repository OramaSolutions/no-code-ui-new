...
const trainingStatusText = () => {
  ...
  if (step === "monitor") return "Training running on RunPod";
        ...
        <>
            ...
            <motion.div className="bg-white rounded-2xl w-full max-w-6xl max-h-[90vh] flex flex-col">
                ...
                <div className="p-6 space-y-6 overflow-y-auto">
                    <TrainingStatusHeader statusText={trainingStatusText()} />
                    ...
                    <TrainingActions isComplete={isCompleted} stoping={stoping} onStop={stopHandler} onProceed={handleProceed} />
                </div>
            </motion.div>
