...
function BasicParameters({ values, onValueChange }) {
    const parameters = [
        {
            ...
            label: 'Image Size',
            type: 'number',
            tooltip: 'Increase the image size if objects to be detected are too small.',
    ...
    const sliderParameters = [
        {
            name: 'test_split',
            label: 'Dataset Split Ratio',
            tooltip: 'Divides the dataset into training and validation sets. Training should always be 80% or above.',
            value: values.test_split,
            min: 0,
            max: 0.3,
            step: 0.01,
            showTrainingValidation: true,
        },
        {
            name: 'mosaic',
            label: 'Mosaic',
